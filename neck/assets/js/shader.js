/*
Shader: Neon Raymarch @boris159
https://www.shadertoy.com/view/7dsXRr
*/
AFRAME.registerShader("wall-shader", {
  schema: {
    iTime: { type: "time", is: "uniform" },
    iResolution: { type: "vec3", is: "uniform", default: { x: 2, y: 1, z: 1 } },
  },
  vertexShader: `
    varying vec2 vUv;
...
{
    seed = iTime*0.001 + iResolution.y * fragCoord.x / iResolution.x + fragCoord.y / iResolution.y;
    vec3 pos = vec3(0, 0, iTime * 0.002);
